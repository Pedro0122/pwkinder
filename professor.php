        ...
        <!-- Spinner End -->
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav mx-auto">
                    ...
                    <a href="pergunta.php" class="nav-item nav-link">Contato</a>
                </div>
                    ...
                    <div class="row g-0">
                        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                            <div class="h-100 d-flex flex-column justify-content-center p-5">
                                ...
                                <form name="formProf" action="professorSalvar.php" method="post">
                                    <div class="row g-3">
                                        <div class="col-sm-12">
                                            <div class="form-floating">
                                                <input type="text" class="form-control border-0" id="gname" placeholder="nome" name="nomeP">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-floating">
                                                <input type="text" class="form-control border-0" id="cname" placeholder="Tempo de experiência" name="tempoE">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-floating">
                                                <input type="text" class="form-control border-0" id="cage" placeholder="Turma disponível" name="turnoD">
